      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            trailing: IconButton(onPressed: (){}, icon: const Icon(FontAwesomeIcons.trash,color: Colors.black,size: 25,)),
            subtitle: Padding(
              padding: const EdgeInsets.only(top: 12.0),
              child: Text('To Be A Professional Flutter Developer',style: TextStyle(
